...
export const DEFAULT_ONBOARDING_TASKS: OnboardingTaskDefinition[] = [
  ...
  },
  {
    ...
    requiredFor: 'all',
    officialUrl: 'https://my.scouting.org/vim2/webscript/output/proxy.aspx?method=ExecuteContainerAPI&container=LMSAgent&api=DeeplLink&Program=YPT',
  ...
  },
  {
    ...
    requiredFor: 'all',
    officialUrl: 'https://training.scouting.org/courses/SCO_800/watch?bc=',
    actionLabel: 'Training Portal',
    requiresAdminVerification: true,
    sortOrder: 90,
  },
